<footer class="site-footer">
    ...
    <div class="footer-one">
            ...
            <div class="footer-top">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
                        <!-- footer-widget -->
                        <div class="footer-widget footer-widget-link wow fadeInLeft animated" data-wow-duration="1500ms"
        ...
        <!-- footer-bottom -->
        <div class="footer-bottom wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="100ms">
            <div class="container">
                <!-- footer-bottom-inner -->
