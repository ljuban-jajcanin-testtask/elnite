<section class="why-choose-two">
    <div class="why-choose-two-bg wow fadeInRight animated" data-wow-duration="1500ms" data-wow-delay="100ms"></div>
    ...
    <div class="container">
        ...
        <div class="why-choose-two-top-box">
            <div class="row">
                <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12">
                    ...
                    <div class="why-choose-two-top-detail wow fadeInLeft animated" data-wow-duration="1500ms"
        ...
        <div class="why-choose-two-bottom wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="100ms">
